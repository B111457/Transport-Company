...
String username="praveen.intern@gmail.com";//emailid
			String password="praveenraj";//emailid password
String from="praveen.intern@gmail.com";// email from which u have to send
...
public boolean sendMail2(String to, String string) throws MessagingException{
	String host="smtp.gmail.com";
	String username="praveen.intern@gmail.com";//emailid
		String password="praveenraj";//emailid password
	String from="praveen.intern@gmail.com";// email from which u have to send
